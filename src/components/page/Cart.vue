<template>
  <div class="buy-car">
    ...
    <div class="item" v-for="item in buyCarList">
      ...
      <div class="fl number">
        <span class="number-btn" @click="reduceNum(item)">-</span><input type="text" v-model="item.number"/><span
        @click="addNum(item)" class="number-btn">+</span>
      </div>
      <div class="fl count">
    ...
    <div class="footer">
      ...
      <input type="button" @click="buyProduct(count)" class="account" :class="{'is-dis':count == 0}" value="结算"
             :disabled="count == 0"/>
    </div>
